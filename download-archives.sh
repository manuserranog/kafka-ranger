...
downloadIfNotPresent postgresql-42.2.16.jre7.jar            https://repo1.maven.org/maven2/org/postgresql/postgresql/42.2.16.jre7
downloadIfNotPresent mysql-connector-java-8.0.28.jar        https://repo1.maven.org/maven2/mysql/mysql-connector-java/8.0.28
